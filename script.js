    ...
    if (contactForm) {
        ...
        contactForm.addEventListener('submit', function(e) {
            ...
            if (isValid) {
                ...
                messageElement.textContent = 'הטופס נשלח בהצלחה' || 'Form submitted successfully';
                contactForm.reset();
                fields.forEach(function(field) {
                    field.classList.remove('valid', 'invalid');
                });
                ...
                messageElement.textContent = 'אנא תקן את השגיאות בטופס' || 'Please correct the errors in the form';
            }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '479a674d-bb8e-450c-9f7f-3952e49abede',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '479a674d-bb8e-450c-9f7f-3952e49abede';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '479a674d-bb8e-450c-9f7f-3952e49abede';
